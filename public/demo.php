...
<head>
    ...
    <title>Demo Mock Loadcell - Egg Sorter</title>
...
<body>
    <header>
        <div>
            <h1>Panel Demo (Mock Loadcell)</h1>
            <p class="subtitle">Simulasi berat telur jika sensor load cell rusak (Demonstrasi)</p>
        </div>
        <nav>
        ...
        function toggleConnection() {
            ...
            ws.onmessage = function(evt) {
                ...
                if (data.cal_factor !== undefined) {
                    const el = document.getElementById('val-cal-factor');
                    if (el) el.innerText = data.cal_factor.toFixed(2);
                }
            ...
            ws.onclose = function() {
                ...
                const calEl = document.getElementById('val-cal-factor');
